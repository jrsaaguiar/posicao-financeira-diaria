...
ITENS_ORDEM = [
    "CARTEIRA","MERCADO PAGO","VEICULO","SEGURADORA","GARANTIA","BANCOS","CARTOES","FUNDAO NOVOS","FIDIC","H.B.PECAS","NOVOS PAGOS","USADOS PAGOS","ESTOQUE PECAS","OBRIG. A PAGA","ADIANTAMENTOS","TRANSITORIA","DIF_TRANS_ADIANT",
]
