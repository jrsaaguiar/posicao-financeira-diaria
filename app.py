...
ITENS_ORDEM = [
    "CARTEIRA","MERCADO PAGO","VEICULO","SEGURADORA","GARANTIA","BANCOS","CARTOES","FUNDAO NOVOS","NOVOS PAGOS","USADOS PAGOS","FIDIC","H.B.PECAS","ESTOQUE PECAS","OBRIG. A PAGA","ADIANTAMENTOS","TRANSITORIA","DIF_TRANS_ADIANT",
]
